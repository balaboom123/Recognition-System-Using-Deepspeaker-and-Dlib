...
if __name__ == "__main__":
    ...
    train_files_dir = f"{root}/data/facial_marks/train"
    print("train file: ", train_files_dir)

    # Where are the testing files?
    test_files_dir = f"{root}/data/facial_marks/test"
    print("test file: ", test_files_dir)
