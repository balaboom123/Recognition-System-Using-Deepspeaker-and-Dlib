    ...
    for person in train_dir:
        ...
        for person_img in pix:
            ...
            Traceback (most recent call last):
              File "C:\Users\user\Github/biometric_recognition/face_encoding.py", line 109, in <module>
                feature, person = get_facial_feature(train_dir)
              File "C:\Users\user\Github/biometric_recognition/face_encoding.py", line 64, in get_facial_feature
                if detection[0]:
            IndexError
