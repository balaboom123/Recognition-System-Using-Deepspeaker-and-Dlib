...
import biometric_recognition.rasta as rasta_utils


def mfcc(signal, sr, n_mfcc=13, n_fft=2048, hop_length=512):
...
def lpcc(lpc_coeff, lpcc_order=48, lpc_order=48):
